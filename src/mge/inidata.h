...
const iniSetting iniSettings[] = {
    ...
    {&Configuration.AntiJitterFix, t_bool, 1, siniMisc, "Anti-Jitter Fix", True, &dictBool, DICTONLY, 0, 0},
    ...
    {&Configuration.DL.FgOD[0], t_float, 1, siniDLWeather, "Clear Fog Offset", "0", NULL, MINMAX, 0, 200},
    ...
    {&Configuration.DL.FgOD[1], t_float, 1, siniDLWeather, "Cloudy Fog Offset", "0", NULL, MINMAX, 0, 200},
    ...
    {&Configuration.DL.FgOD[2], t_float, 1, siniDLWeather, "Foggy Fog Offset", "30", NULL, MINMAX, 0, 200},
    ...
    {&Configuration.DL.FgOD[3], t_float, 1, siniDLWeather, "Overcast Fog Offset", "0", NULL, MINMAX, 0, 200},
    ...
    {&Configuration.DL.FgOD[4], t_float, 1, siniDLWeather, "Rain Fog Offset", "10", NULL, MINMAX, 0, 200},
    ...
    {&Configuration.DL.FgOD[5], t_float, 1, siniDLWeather, "Thunderstorm Fog Offset", "20", NULL, MINMAX, 0, 200},
    {&Configuration.DL.Wind[6], t_float, 1, siniDLWeather, "Ashstorm Wind Ratio", "0.8", NULL, MINMAX, 0, 1},
    {&Configuration.DL.FogD[6], t_float, 1, siniDLWeather, "Ashstorm Fog Ratio", "0.25", NULL, MINMAX, 0.001, 2},
    {&Configuration.DL.FgOD[6], t_float, 1, siniDLWeather, "Ashstorm Fog Offset", "45", NULL, MINMAX, 0, 200},
    {&Configuration.DL.Wind[7], t_float, 1, siniDLWeather, "Blight Wind Ratio", "0.9", NULL, MINMAX, 0, 1},
    {&Configuration.DL.FogD[7], t_float, 1, siniDLWeather, "Blight Fog Ratio", "0.25", NULL, MINMAX, 0.001, 2},
    {&Configuration.DL.FgOD[7], t_float, 1, siniDLWeather, "Blight Fog Offset", "50", NULL, MINMAX, 0, 200},
    ...
    {&Configuration.DL.FgOD[8], t_float, 1, siniDLWeather, "Snow Fog Offset", "40", NULL, MINMAX, 0, 200},
    ...
    {&Configuration.DL.FgOD[9], t_float, 1, siniDLWeather, "Blizzard Fog Offset", "100", NULL, MINMAX, 0, 200},
